...
for subdir in [0-9]*; do
    ...
    git mv -fk ${subdir}/T1w/T1w_acpc_dc_restore.nii.gz ${newsub}/anat/${newsub}_desc-dc-restore_T1w.nii.gz || true
    ...
    git mv -fk ${subdir}/T1w/T2w_acpc_dc_restore.nii.gz ${newsub}/anat/${newsub}_desc-dc-restore_T2w.nii.gz || true
